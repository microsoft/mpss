...
namespace mpss {
    ...
    public:
         ...
         * @note This function provides control to the user as to when to release the key pair
         * handle. It is not necessary to call this function directly, they key pair handle will be
         * released automatically when the @ref KeyPair instance is destroyed. After calling this
         * function, the key pair handle is no longer valid.
         */
