...
extern "C"
{
    ...
    bool VerifyStandaloneSignatureMacOS(int signatureType, const std::uint8_t *hash, std::size_t hashSize, const std::uint8_t *publicKey, std::size_t publicKeySize, const std::uint8_t *signature, std::size_t signatureSize);
