...
bool MPSS_SE_Sign(
    const char *keyName, const std::uint8_t *hash, std::size_t hashSize, std::uint8_t *sig, std::size_t *sigSize);
bool MPSS_SE_VerifySignature(
    const char *keyName, const std::uint8_t *hash, std::size_t hashSize, const std::uint8_t *sig, std::size_t sigSize);
