...
namespace mpss_openssl::utils {
    inline constexpr char* ec_encoder_names = "EC";

    inline constexpr char* ec_key_names = "EC:id_ecPublicKey:1.2.840.10045.2.1";
    ...
    inline constexpr std::array<const char*, 1> mpss_sig_names = {
        "ECDSA:ecdsa"
    };
